...
@interface CPTAxis : CPTLayer {   
	...
	__unsafe_unretained CPTPlotArea *plotArea;
	__unsafe_unretained CPTGridLines *minorGridLines;
	__unsafe_unretained CPTGridLines *majorGridLines;
}
...
@property (nonatomic, readwrite, assign) __unsafe_unretained CPTPlotArea *plotArea;
@property (nonatomic, readonly, assign) __unsafe_unretained CPTGridLines *minorGridLines;
@property (nonatomic, readonly, assign) __unsafe_unretained CPTGridLines *majorGridLines;
