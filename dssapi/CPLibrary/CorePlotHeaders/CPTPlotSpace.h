...
@interface CPTPlotSpace : NSObject <CPTResponder, NSCoding> {
	@private
    __unsafe_unretained CPTGraph *graph;
	id <NSCopying, NSCoding, NSObject> identifier;
    __unsafe_unretained id <CPTPlotSpaceDelegate> delegate;
...
@property (nonatomic, readwrite, assign) __unsafe_unretained CPTGraph *graph;
@property (nonatomic, readwrite, assign) __unsafe_unretained id <CPTPlotSpaceDelegate> delegate;
