...
//  dssapi
//
//  Created by Imac DOM on 6/5/12.
//  Copyright (c) 2012 __MyCompanyName__. All rights reserved.
//

#import "misSalesAnalysis.h"

@implementation misSalesAnalysis
...
- (id) initReportForDate:(NSString*) p_fordate andDayOffset:(int) p_dayoffset andFrame:(CGRect) frame forOrientation:(UIInterfaceOrientation) p_intOrientation
{
    ...
    if (self) {
        ...
        //[[NSNotifxicationCenter defaultCenter] addObserver:self selector:@selector(reportCoreDataGenerated:)  name:@"MISSalesAnalysisGenerated" object:nil];
        [navTitle setTitle:@"Sales Analysis"];
...
- (void) generateDataForOffset:(int) p_addOffset
{
    if (populationOnProgress==NO)
    {
        ...
        NSDictionary *inputDict = [[NSDictionary alloc] initWithObjectsAndKeys:[NSString stringWithFormat:@"%d", _offset],@"p_dayoffset",@"MIS_SalesAnalysis",@"p_reporttype",  nil];
        METHODCALLBACK l_proxyReturn = ^(NSDictionary* p_dictInfo)
        {
            [self reportCoreDataGenerated:p_dictInfo];
        };
        [[dssWSCallsProxy alloc] initWithReportType:@"MISSALESANALYSIS" andInputParams:inputDict andReturnMethod:l_proxyReturn andReturnInputs:NO];
    }
}
...
- (UITableViewCell*) getDetailCell:(UITableView*) p_dispTV andData:(NSDictionary*) p_dataDict forRowNo:(int) p_rowNo
{
    ...
    if(cell == nil) 
    {
        ...
        for (int _lblNo = 0; _lblNo<10; _lblNo++) 
        {
            txtAlign = 2;
            [frm setMaximumFractionDigits:0];
            switch (_lblNo) {
                ...
                case 1:
                    xWidth = smWidth;
                    strTitle = [[NSString alloc] initWithFormat:@"%@ ",[p_dataDict valueForKey:@"SALESMANNAME"]];
                    txtAlign = 1;
                    lblBackColor = [UIColor colorWithRed:0.0 green:0.7 blue:0.0 alpha:0.4];
                    break;
                case 2:
                    xWidth = colWidth;
                    strTitle = [[NSString alloc] initWithFormat:@"%@",[frm stringFromNumber:[NSNumber numberWithInteger:[[p_dataDict valueForKey:@"DAILYCURRTOTAL"] integerValue]]]];
                    lblBackColor = [UIColor colorWithRed:205.0f/255.0f green:133.0f/255.0f blue:63.0f/255.0f alpha:1.0];
                    break;
                case 3:
                    xWidth = colWidth;
                    strTitle = [[NSString alloc] initWithFormat:@"%@",[frm stringFromNumber:[NSNumber numberWithInteger:[[p_dataDict valueForKey:@"DAILYPREVTOTAL"] integerValue]]]];
                    lblBackColor = [UIColor colorWithRed:205.0f/255.0f green:133.0f/255.0f blue:63.0f/255.0f alpha:1.0];
                    break;
                case 4:
                    xWidth = colWidth;
                ...
                case 5:
                    xWidth = colWidth;
                    strTitle = [[NSString alloc] initWithFormat:@"%@",[frm stringFromNumber:[NSNumber numberWithInteger:[[p_dataDict valueForKey:@"DAILYPREVMONTHTOTAL"] integerValue]]]];
                    lblBackColor = [UIColor colorWithRed:244.0f/255.0f green:194.0f/255.0f blue:194.0f/255.0f alpha:1.0];
                    break;
                case 6:
                    xWidth = colWidth;
                    strTitle = [[NSString alloc] initWithFormat:@"%@",[frm stringFromNumber:[NSNumber numberWithInteger:[[p_dataDict valueForKey:@"PREVIOUSMONTHTOTAL"] integerValue]]]];
                    lblBackColor = [UIColor colorWithRed:244.0f/255.0f green:194.0f/255.0f blue:194.0f/255.0f alpha:1.0];
                    break;
                case 7:
                    xWidth = colWidth;
                ...
                case 8:
                    xWidth = colWidth;
                    strTitle = [[NSString alloc] initWithFormat:@"%@",[frm stringFromNumber:[NSNumber numberWithInteger:[[p_dataDict valueForKey:@"QUANTITY"] integerValue]]]];
                ...
                case 9:
                    ...
                    strTitle = [[NSString alloc] initWithFormat:@"%@",[frm stringFromNumber:[NSNumber numberWithDouble:[[p_dataDict valueForKey:@"AVERAGE"] doubleValue]]]];
                    lblBackColor = [UIColor colorWithRed:247.0f/255.0f green:127.0f/255.0f blue:190.0f/255.0f alpha:1.0];
                    break;
                default:
                    break;
    ...
    if(cell == nil) {
        ...
        for (int _lblNo = 0; _lblNo<10; _lblNo++) 
        {
            switch (_lblNo) {
                ...
                case 1:
                    xWidth = smWidth;
                    strTitle = [[NSString alloc] initWithString:@"Salesman"];
                    break;
                case 2:
                    xWidth = colWidth;
                ...
                case 8:
                    xWidth = colWidth;
                    strTitle = [[NSString alloc] initWithString:@"Quantity"];
                    break;
                case 9:
                    xWidth = colWidth;
                    strTitle = [[NSString alloc] initWithString:@"Average"];
                    break;
                default:
                    break;
            }
